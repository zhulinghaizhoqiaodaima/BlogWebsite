...
const getAuditList = (username: any): Promise<any> => http.get(`/news?author=${username}&auditState_ne=0&publicState_lte=1`) // _ne->! lte -> <


export { CreateNews, getSelfDraft, deletenewsOne, getNewsOne, UpdateNews, UpdateAuditState,getAuditList }
